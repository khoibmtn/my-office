                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {(() => {
                          const name = task.assigneeName || (task.assigneeId ? getStaffName(task.assigneeId) : null)
                          return name ? (
                            <div className="w-5 h-5 rounded-full bg-blue-100 flex items-center justify-center" title={name}>
